...
var I18N = {
  en: {
    ...
    htMystery: 'Small ? squares disappear when the first racer touches them. They last 10 seconds and blink before expiring. One fills your slot with either a fake square or a yellow bolt: use Shift, tap the bottom-right slot, or double-tap to spend it. The fake square is a trap dropped behind you, and its upside-down ? removes the first racer to hit it; the bolt is the yellow pad\u2019s shove, carried with you.',
