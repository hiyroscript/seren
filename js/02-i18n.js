...
var I18N = {
  en: {
    ...
    htMystery: 'Small ? squares disappear when the first racer touches them. They last 10 seconds and blink before expiring. They grant a fake square: use Shift, tap the bottom-right slot, or double-tap to drop it behind you. Its upside-down ? marks a trap that removes the first racer to hit it.',
  ...
  fr: {
    ...
    htMystery: 'Les petits carrés ? disparaissent au contact du premier coureur. Ils durent 10 secondes et clignotent avant de disparaître. Ils donnent un faux carré : Maj, le bouton en bas à droite ou un double appui le dépose derrière vous. Son ? renversé indique un piège qui élimine le premier coureur touché.',
